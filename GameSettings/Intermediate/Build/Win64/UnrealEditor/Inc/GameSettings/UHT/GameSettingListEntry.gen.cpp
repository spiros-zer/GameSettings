...
// ********** Begin Function GetPrimaryGamepadFocusWidget constinit property declarations **********
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function GetPrimaryGamepadFocusWidget constinit property declarations ************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function GetPrimaryGamepadFocusWidget Property Definitions *********************
...
// ********** End Function GetPrimaryGamepadFocusWidget Property Definitions ***********************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntryBase, nullptr, "GetPrimaryGamepadFocusWidget", 	Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget_Statics::PropPointers), 
sizeof(GameSettingListEntryBase_eventGetPrimaryGamepadFocusWidget_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080802, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntryBase;
UClass* UGameSettingListEntryBase::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntryBase;
	if (!Z_Registration_Info_UClass_UGameSettingListEntryBase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntryBase"),
			Z_Registration_Info_UClass_UGameSettingListEntryBase.InnerSingleton,
			StaticRegisterNativesUGameSettingListEntryBase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UGameSettingListEntryBase.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntryBase_NoRegister()
{
	return UGameSettingListEntryBase::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntryBase constinit property declarations ****************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntryBase constinit property declarations ******************
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameSettingListEntryBase_GetPrimaryGamepadFocusWidget, "GetPrimaryGamepadFocusWidget" }, // 3898591142
	};
...
// ********** Begin Class UGameSettingListEntryBase Property Definitions ***************************
...
// ********** End Class UGameSettingListEntryBase Property Definitions *****************************
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UGameSettingListEntryBase_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UUserObjectListEntry_NoRegister, (int32)VTABLE_OFFSET(UGameSettingListEntryBase, IUserObjectListEntry), false },  // 1012633399
};
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntryBase);
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntry_Setting;
UClass* UGameSettingListEntry_Setting::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntry_Setting;
	if (!Z_Registration_Info_UClass_UGameSettingListEntry_Setting.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntry_Setting"),
			Z_Registration_Info_UClass_UGameSettingListEntry_Setting.InnerSingleton,
			StaticRegisterNativesUGameSettingListEntry_Setting,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UGameSettingListEntry_Setting.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntry_Setting_NoRegister()
{
	return UGameSettingListEntry_Setting::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntry_Setting constinit property declarations ************
	static const UECodeGen_Private::FObjectPropertyParams NewProp_Text_SettingName;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntry_Setting constinit property declarations **************
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Class UGameSettingListEntry_Setting Property Definitions ***********************
...
// ********** End Class UGameSettingListEntry_Setting Property Definitions *************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntry_Setting);
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntrySetting_Discrete;
UClass* UGameSettingListEntrySetting_Discrete::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntrySetting_Discrete;
	if (!Z_Registration_Info_UClass_UGameSettingListEntrySetting_Discrete.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntrySetting_Discrete"),
			Z_Registration_Info_UClass_UGameSettingListEntrySetting_Discrete.InnerSingleton,
			StaticRegisterNativesUGameSettingListEntrySetting_Discrete,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UGameSettingListEntrySetting_Discrete.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntrySetting_Discrete_NoRegister()
{
	return UGameSettingListEntrySetting_Discrete::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntrySetting_Discrete constinit property declarations ****
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntrySetting_Discrete constinit property declarations ******
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Class UGameSettingListEntrySetting_Discrete Property Definitions ***************
...
// ********** End Class UGameSettingListEntrySetting_Discrete Property Definitions *****************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntrySetting_Discrete);
...
// ********** Begin Function HandleSliderCaptureEnded constinit property declarations **************
// ********** End Function HandleSliderCaptureEnded constinit property declarations ****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderCaptureEnded_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Scalar, nullptr, "HandleSliderCaptureEnded", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderCaptureEnded_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderCaptureEnded_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function HandleSliderValueChanged constinit property declarations **************
	static const UECodeGen_Private::FFloatPropertyParams NewProp_Value;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function HandleSliderValueChanged constinit property declarations ****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function HandleSliderValueChanged Property Definitions *************************
...
// ********** End Function HandleSliderValueChanged Property Definitions ***************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Scalar, nullptr, "HandleSliderValueChanged", 	Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::GameSettingListEntrySetting_Scalar_eventHandleSliderValueChanged_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function OnDefaultValueChanged constinit property declarations *****************
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DefaultValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnDefaultValueChanged constinit property declarations *******************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnDefaultValueChanged Property Definitions ****************************
...
// ********** End Function OnDefaultValueChanged Property Definitions ******************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Scalar, nullptr, "OnDefaultValueChanged", 	Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged_Statics::PropPointers), 
sizeof(GameSettingListEntrySetting_Scalar_eventOnDefaultValueChanged_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080802, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function OnValueChanged constinit property declarations ************************
	static const UECodeGen_Private::FFloatPropertyParams NewProp_Value;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnValueChanged constinit property declarations **************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnValueChanged Property Definitions ***********************************
...
// ********** End Function OnValueChanged Property Definitions *************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Scalar, nullptr, "OnValueChanged", 	Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged_Statics::PropPointers), 
sizeof(GameSettingListEntrySetting_Scalar_eventOnValueChanged_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080802, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntrySetting_Scalar;
UClass* UGameSettingListEntrySetting_Scalar::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntrySetting_Scalar;
	if (!Z_Registration_Info_UClass_UGameSettingListEntrySetting_Scalar.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntrySetting_Scalar"),
			Z_Registration_Info_UClass_UGameSettingListEntrySetting_Scalar.InnerSingleton,
			StaticRegisterNativesUGameSettingListEntrySetting_Scalar,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UGameSettingListEntrySetting_Scalar.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntrySetting_Scalar_NoRegister()
{
	return UGameSettingListEntrySetting_Scalar::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntrySetting_Scalar constinit property declarations ******
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntrySetting_Scalar constinit property declarations ********
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("HandleSliderCaptureEnded"), .Pointer = &UGameSettingListEntrySetting_Scalar::execHandleSliderCaptureEnded },
		{ .NameUTF8 = UTF8TEXT("HandleSliderValueChanged"), .Pointer = &UGameSettingListEntrySetting_Scalar::execHandleSliderValueChanged },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderCaptureEnded, "HandleSliderCaptureEnded" }, // 1977689863
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_HandleSliderValueChanged, "HandleSliderValueChanged" }, // 533111489
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnDefaultValueChanged, "OnDefaultValueChanged" }, // 3154622418
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Scalar_OnValueChanged, "OnValueChanged" }, // 2697904401
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Class UGameSettingListEntrySetting_Scalar Property Definitions *****************
...
// ********** End Class UGameSettingListEntrySetting_Scalar Property Definitions *******************
...
void UGameSettingListEntrySetting_Scalar::StaticRegisterNativesUGameSettingListEntrySetting_Scalar()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UGameSettingListEntrySetting_Scalar_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntrySetting_Scalar);
...
// ********** Begin Function OnSettingAssigned constinit property declarations *********************
	static const UECodeGen_Private::FTextPropertyParams NewProp_ActionText;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnSettingAssigned constinit property declarations ***********************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnSettingAssigned Property Definitions ********************************
...
// ********** End Function OnSettingAssigned Property Definitions **********************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Action, nullptr, "OnSettingAssigned", 	Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned_Statics::PropPointers), 
sizeof(GameSettingListEntrySetting_Action_eventOnSettingAssigned_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08480802, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntrySetting_Action;
UClass* UGameSettingListEntrySetting_Action::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntrySetting_Action;
	if (!Z_Registration_Info_UClass_UGameSettingListEntrySetting_Action.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntrySetting_Action"),
			Z_Registration_Info_UClass_UGameSettingListEntrySetting_Action.InnerSingleton,
	...
	return Z_Registration_Info_UClass_UGameSettingListEntrySetting_Action.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntrySetting_Action_NoRegister()
{
	return UGameSettingListEntrySetting_Action::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntrySetting_Action constinit property declarations ******
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntrySetting_Action constinit property declarations ********
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Action_OnSettingAssigned, "OnSettingAssigned" }, // 1279587057
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Class UGameSettingListEntrySetting_Action Property Definitions *****************
...
// ********** End Class UGameSettingListEntrySetting_Action Property Definitions *******************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntrySetting_Action);
...
// ********** End Function OnSettingAssigned Property Definitions **********************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingListEntrySetting_Navigation, nullptr, "OnSettingAssigned", 	Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned_Statics::PropPointers), 
sizeof(GameSettingListEntrySetting_Navigation_eventOnSettingAssigned_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08480802, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingListEntrySetting_Navigation;
UClass* UGameSettingListEntrySetting_Navigation::GetPrivateStaticClass()
{
	using TClass = UGameSettingListEntrySetting_Navigation;
	if (!Z_Registration_Info_UClass_UGameSettingListEntrySetting_Navigation.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingListEntrySetting_Navigation"),
			Z_Registration_Info_UClass_UGameSettingListEntrySetting_Navigation.InnerSingleton,
			StaticRegisterNativesUGameSettingListEntrySetting_Navigation,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UGameSettingListEntrySetting_Navigation.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingListEntrySetting_Navigation_NoRegister()
{
	return UGameSettingListEntrySetting_Navigation::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingListEntrySetting_Navigation constinit property declarations **
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingListEntrySetting_Navigation constinit property declarations ****
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameSettingListEntrySetting_Navigation_OnSettingAssigned, "OnSettingAssigned" }, // 429294175
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Class UGameSettingListEntrySetting_Navigation Property Definitions *************
...
// ********** End Class UGameSettingListEntrySetting_Navigation Property Definitions ***************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingListEntrySetting_Navigation);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h__Script_GameSettings_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingListEntryBase, UGameSettingListEntryBase::StaticClass, TEXT("UGameSettingListEntryBase"), &Z_Registration_Info_UClass_UGameSettingListEntryBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingListEntryBase), 123670307U) },
		{ Z_Construct_UClass_UGameSettingListEntry_Setting, UGameSettingListEntry_Setting::StaticClass, TEXT("UGameSettingListEntry_Setting"), &Z_Registration_Info_UClass_UGameSettingListEntry_Setting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingListEntry_Setting), 2584194994U) },
...
}; // Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h__Script_GameSettings_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h__Script_GameSettings_232517323{
	TEXT("/Script/GameSettings"),
	Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h__Script_GameSettings_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingListEntry_h__Script_GameSettings_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
