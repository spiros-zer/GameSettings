...
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingRegistry;
UClass* UGameSettingRegistry::GetPrivateStaticClass()
{
	using TClass = UGameSettingRegistry;
	if (!Z_Registration_Info_UClass_UGameSettingRegistry.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingRegistry"),
			Z_Registration_Info_UClass_UGameSettingRegistry.InnerSingleton,
			StaticRegisterNativesUGameSettingRegistry,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UGameSettingRegistry.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingRegistry_NoRegister()
{
	return UGameSettingRegistry::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingRegistry constinit property declarations *********************
...
// ********** End Class UGameSettingRegistry constinit property declarations ***********************
...
// ********** Begin Class UGameSettingRegistry Property Definitions ********************************
...
// ********** End Class UGameSettingRegistry Property Definitions **********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingRegistry);
UGameSettingRegistry::~UGameSettingRegistry() {}
// ********** End Class UGameSettingRegistry *******************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_GameSettingRegistry_h__Script_GameSettings_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingRegistry, UGameSettingRegistry::StaticClass, TEXT("UGameSettingRegistry"), &Z_Registration_Info_UClass_UGameSettingRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingRegistry), 1280970012U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_GameSettingRegistry_h__Script_GameSettings_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_GameSettingRegistry_h__Script_GameSettings_3085659136{
	TEXT("/Script/GameSettings"),
	Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_GameSettingRegistry_h__Script_GameSettings_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_GameSettingRegistry_h__Script_GameSettings_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
