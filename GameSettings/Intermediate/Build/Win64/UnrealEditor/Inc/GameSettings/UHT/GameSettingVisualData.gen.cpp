...
{
	static inline consteval int32 GetStructSize() { return sizeof(FGameSettingClassExtensions); }
	static inline consteval int16 GetStructAlignment() { return alignof(FGameSettingClassExtensions); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FGameSettingClassExtensions constinit property declarations *******
...
// ********** End ScriptStruct FGameSettingClassExtensions constinit property declarations *********
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions;
class UScriptStruct* FGameSettingClassExtensions::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameSettingClassExtensions, (UObject*)Z_Construct_UPackage__Script_GameSettings(), TEXT("GameSettingClassExtensions"));
	}
	return Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.OuterSingleton;
	}

// ********** Begin ScriptStruct FGameSettingClassExtensions Property Definitions ******************
...
// ********** End ScriptStruct FGameSettingClassExtensions Property Definitions ********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.InnerSingleton, Z_Construct_UScriptStruct_FGameSettingClassExtensions_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FGameSettingNameExtensions); }
	static inline consteval int16 GetStructAlignment() { return alignof(FGameSettingNameExtensions); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Widgets/GameSettingVisualData.h" },
...
// ********** Begin ScriptStruct FGameSettingNameExtensions constinit property declarations ********
	...
	static const UECodeGen_Private::FArrayPropertyParams NewProp_Extensions;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FGameSettingNameExtensions constinit property declarations **********
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions;
class UScriptStruct* FGameSettingNameExtensions::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameSettingNameExtensions, (UObject*)Z_Construct_UPackage__Script_GameSettings(), TEXT("GameSettingNameExtensions"));
	}
	return Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.OuterSingleton;
	}

// ********** Begin ScriptStruct FGameSettingNameExtensions Property Definitions *******************
...
// ********** End ScriptStruct FGameSettingNameExtensions Property Definitions *********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.InnerSingleton, Z_Construct_UScriptStruct_FGameSettingNameExtensions_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions.InnerSingleton);
}
// ********** End ScriptStruct FGameSettingNameExtensions ******************************************

// ********** Begin Class UGameSettingVisualData ***************************************************
FClassRegistrationInfo Z_Registration_Info_UClass_UGameSettingVisualData;
UClass* UGameSettingVisualData::GetPrivateStaticClass()
{
	using TClass = UGameSettingVisualData;
	if (!Z_Registration_Info_UClass_UGameSettingVisualData.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("GameSettingVisualData"),
			Z_Registration_Info_UClass_UGameSettingVisualData.InnerSingleton,
			StaticRegisterNativesUGameSettingVisualData,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UGameSettingVisualData.InnerSingleton;
}
UClass* Z_Construct_UClass_UGameSettingVisualData_NoRegister()
{
	return UGameSettingVisualData::GetPrivateStaticClass();
}
...
// ********** Begin Class UGameSettingVisualData constinit property declarations *******************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UGameSettingVisualData constinit property declarations *********************
...
// ********** Begin Class UGameSettingVisualData Property Definitions ******************************
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UGameSettingVisualData_Statics::NewProp_EntryWidgetForClass_ValueProp = { "EntryWidgetForClass", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_UGameSettingListEntryBase_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UGameSettingVisualData_Statics::NewProp_EntryWidgetForClass_Key_KeyProp = { "EntryWidgetForClass_Key", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_UGameSetting_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UGameSettingVisualData_Statics::NewProp_EntryWidgetForName_ValueProp = { "EntryWidgetForName", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_UGameSettingListEntryBase_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameSettingVisualData_Statics::NewProp_ExtensionsForClasses_ValueProp = { "ExtensionsForClasses", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FGameSettingClassExtensions, METADATA_PARAMS(0, nullptr) }; // 1345855890
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UGameSettingVisualData_Statics::NewProp_ExtensionsForClasses_Key_KeyProp = { "ExtensionsForClasses_Key", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_UGameSetting_NoRegister, METADATA_PARAMS(0, nullptr) };
...
// ********** End Class UGameSettingVisualData Property Definitions ********************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UGameSettingVisualData);
UGameSettingVisualData::~UGameSettingVisualData() {}
// ********** End Class UGameSettingVisualData *****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FGameSettingClassExtensions::StaticStruct, Z_Construct_UScriptStruct_FGameSettingClassExtensions_Statics::NewStructOps, TEXT("GameSettingClassExtensions"),&Z_Registration_Info_UScriptStruct_FGameSettingClassExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameSettingClassExtensions), 1345855890U) },
		{ FGameSettingNameExtensions::StaticStruct, Z_Construct_UScriptStruct_FGameSettingNameExtensions_Statics::NewStructOps, TEXT("GameSettingNameExtensions"),&Z_Registration_Info_UScriptStruct_FGameSettingNameExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameSettingNameExtensions), 707635117U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingVisualData, UGameSettingVisualData::StaticClass, TEXT("UGameSettingVisualData"), &Z_Registration_Info_UClass_UGameSettingVisualData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingVisualData), 2105868595U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_2177418260{
	TEXT("/Script/GameSettings"),
	Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_spiro_Documents_Unreal_Projects_Ecifircas_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h__Script_GameSettings_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
